function schedulingDB()
    ...
    processing_times_gen = generate_pt(5);
    disp(processing_times_gen);
...
% sqlquery = sprintf("INSERT INTO pt (id, machine_id, processing_time) VALUES (%d, %d, %d)", ...
%            id, machine_id, processing_time);
